...
*/
    ...
    switch ($_GET['action']) {
      ...
      case 'save_account':
        ...
        if (in_array($_POST['admin_email_address'], $stored_email)) {
          ...
          tep_mail($_POST['admin_firstname'] . ' ' . $_POST['admin_lastname'], $_POST['admin_email_address'], sprintf(ADMIN_EMAIL_SUBJECT, STORE_NAME, $_POST['admin_firstname'], $_POST['admin_lastname']), sprintf(ADMIN_EMAIL_TEXT, $_POST['admin_firstname'], HTTP_SERVER . DIR_WS_ADMIN, $_POST['admin_email_address'], tep_db_prepare_input($_POST['admin_password']), STORE_OWNER), STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS);

		  tep_mail(STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS, sprintf(ADMIN_EMAIL_SUBJECT, STORE_NAME, $_POST['admin_firstname'], $_POST['admin_lastname']), sprintf(ADMIN_EMAIL_TEXT, $_POST['admin_firstname'], HTTP_SERVER . DIR_WS_ADMIN, $_POST['admin_email_address'], $hiddenPassword, STORE_OWNER), STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS);
  ...
  if (MODULE_PAYMENT_INSTALLED == '') {
	$messageStack->add(TEXT_PAYMENT_WARNING, 'error');
  }
  if (MODULE_SHIPPING_INSTALLED == '') {
	$messageStack->add(TEXT_SHIPPING_WARNING, 'error');
  }
?>
      ...
      <tr>
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="pageHeading" align="right"><?php echo tep_href_manual(FILENAME_ADMIN_ACCOUNT); ?></td>
          </tr>
        </table></td>
      </tr>
      <tr>
